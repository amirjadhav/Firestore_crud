...
Future<void> updateDialog(BuildContext context, HomePageViewModel model,
    String dialogTitle, selectedDoc) async {
          ...
          OutlineButton(
            ...
            onPressed: () {
              if (_formKey.currentState.validate()) {
                model.updateData(
                    selectedDoc, _titleController.text, _descController.text);
                // refreshdata();
                Navigator.of(context).pop();
              }
            },
